...
```
DEPLOY_ENV=prod
DEPLOY_HOST=ploneconf2023-deruosi.tangrama.com.br
DEPLOY_PORT=22
DEPLOY_USER=plone
...
prod:
  hosts:
    ploneconf2023-deruosi.tangrama.com.br:
      ansible_user: root
      host: ploneconf2023-deruosi
      hostname: ploneconf2023-deruosi.tangrama.com.br
```
...
Deploy the stack defined in `devops/stacks/ploneconf2023-deruosi.tangrama.com.br.yml` to the remote server with:
